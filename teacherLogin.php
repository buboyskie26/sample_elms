<?php
    ...
    if(isset($_POST['teacherLoginButton'])){

        $username = FormSanitizer::SanitizeFormUsername($_POST['username']);
        $password = FormSanitizer::SanitizeFormUsername($_POST['password']);


        $wasSuccessful = $account->loginTeacherUser($username, $password);

        if($wasSuccessful == true){
            $_SESSION['teacherUserLoggedIn'] = $username;
            ...
            <div class="column">
                ...
                <div class="buttons">
                    ...
                    <a href="studentLogin.php">
                        <button class="btn btn-primary btn-sm">Student</button>
                    </a>
                </div>
                <div class="loginForm">
                    <form action="teacherLogin.php" method="POST">
                        ...
                        <input type="submit" name="teacherLoginButton" value="Login">
                    </form>
                </div>
            </div>
        </div>
